const probleAndages = document.querySelector("#sam3");
...
next3.onclick = () => {
    ...
    if (que_count < PROBLEMnAGES.length - 1) {
        que_count++;
        que_numb++;
...
function showQuestionages(index) {
    ...
    let que_tag = '<span>' + PROBLEMnAGES[index].numb + ". " + PROBLEMnAGES[index].question + '</span>';
    let option_tag = '<span class="option">' + PROBLEMnAGES[index].options[0] + '</span>'
        + '<span class="option">' + PROBLEMnAGES[index].options[1] + '</span>'
        + '<span class="option">' + PROBLEMnAGES[index].options[2] + '</span>'
        + '<span class="option">' + PROBLEMnAGES[index].options[3] + '</span>';
...
function optionSelectedages(answer) {
    ...
    let correctAns = PROBLEMnAGES[que_count].answer;
